...
%This script imports and processes the simulation data from the linear 
...
sim_name = 'no_osm_sweep_Keq_10_no_sat';
num_jobs = 800;
run_per_job = 50;
E_cutoff = 1e-6;
enzyme_only = 1;
...
point6 = point5 + point_mult*[4.5,0];
make_rec(point6,mymap(unique_phases==-1,:))
text(point6(1) + point_offset,point6(2),'Osc.',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',14);

%print(gcf, '-dpng','plots/no_osm_sweep_Keq_10_no_sat_phase_diagram.png','-r400');
