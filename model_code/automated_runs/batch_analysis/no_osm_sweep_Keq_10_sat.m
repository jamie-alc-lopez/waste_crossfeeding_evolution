...
%This script imports and processes the simulation data from the saturating 
%model with Keq 10. It also plots a rough phase diagram for diagnostic
%purposes, the final phase diagram scripts are in the figure_generation
%folder

sim_name = 'no_osm_sweep_Keq_10_sat';
num_jobs = 1989;
run_per_job = 10;
E_cutoff = 1e-6;
enzyme_only = 1;
