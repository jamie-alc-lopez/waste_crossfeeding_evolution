...
%model with Keq1=1 and Keq2=0.1. It also plots a rough phase diagram for 
%diagnostic purposes, the final phase diagram scripts are in the 
%figure_generation folder

sim_name = 'no_osm_sweep_Keq1_1_Keq2_0p1_no_sat';
num_jobs = 800;
run_per_job = 50;
E_cutoff = 1e-6;
enzyme_only = 0;
...
figure
imagesc(data,'AlphaData',~isnan(data),[0,4])
...
point_offset = 10*0.5;
point1 = [0,170];
make_rec(point1,mymap(1,:))
text(point1(1) + point_offset,point1(2),'$\emptyset$',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',18);

point2 = point1 + 10*[3,0];
make_rec(point2,mymap(2,:))
text(point2(1) + point_offset,point2(2),'P1',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',14);

point3 = point2 + 10*[3.5,0];
make_rec(point3,mymap(3,:))
text(point3(1) + point_offset,point3(2),'P2',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',14);

point4 = point3 + 10*[3.5,0];
make_rec(point4,mymap(4,:))
text(point4(1) + point_offset,point4(2),'P1/P2',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',14);

point5 = point4 + 10*[4.5,0];
make_rec(point5,mymap(5,:))
