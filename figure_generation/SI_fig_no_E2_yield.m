...
sim_file = ['fig_data/no_osm_sweep_Keq_1_alpha2_0_no_sat_simulation_results.mat'];
[lower_bounds,upper_bounds,phase_types,sr] = make_osm_phase_diagram(sim_file);
save(['fig_data/phase_diagram_data_no_osm_sweep_Keq_1_alpha2_0_no_sat.mat']);
...
hold on 
filename = ['fig_data/phase_diagram_data_no_osm_sweep_Keq_1_alpha2_0_no_sat.mat'];
load(filename);
...
make_rec(point3,colors(4,:))
text(point3(1) + point_offset,point3(2),'P1+P2',...
    'HorizontalAlignment','left','VerticalAlignment','middle',...
    'Interpreter','latex','FontSize',4);

print(gcf, '-dpng','figs/SI_fig_no_E2_yield.png','-r800','-painters');
